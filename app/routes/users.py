...
from app.crud import get_user_by_email, createuser ,get_user_by_id
...
@router.get("/users/{user_mail}", response_model= UserResponse ,description= "get the user by email")
